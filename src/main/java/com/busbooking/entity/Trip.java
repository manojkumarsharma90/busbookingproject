...
public class Trip {
    ...
    public Trip(Long tripId, Route route, Bus bus, Address boardingAddress,
                Address droppingAddress, Driver driver1, Driver driver2,
                LocalDateTime departureTime, LocalDateTime arrivalTime,
                LocalDate tripDate, Integer availableSeats, BigDecimal fare) {
